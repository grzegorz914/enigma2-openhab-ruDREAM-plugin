...
def initConfig():
    ...
    config_root.slider_style = ConfigSelection(default='0', choices=[(str(0), _("Number")), 
                                                                     (str(1), _("Slider"))]) 
    config_root.debug = ConfigSelection(default=str(OFF_LEVEL), choices=[(str(OFF_LEVEL), _("no")),
